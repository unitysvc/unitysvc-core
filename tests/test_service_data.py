"""Tests for the ServiceData model (the service.json provenance structure)."""
...
from unitysvc_core.models import ServiceData
...
def test_service_id_coerced_to_uuid() -> None:
    sd = ServiceData.model_validate({"service_id": _SID})
...
def test_time_created_and_extra_fields() -> None:
    ...
    sd = ServiceData.model_validate({"service_id": _SID, "time_created": "2026-01-01T00:00:00", "note": "x"})
